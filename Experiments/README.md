# Experiments — Live Test Results & Replication Hub

**Project White Hole — LS7 Natural Operating System (NOS) / 1/7 Framework**

This folder contains real-world tests of loading NOS / 1/7 cyclic parity into LLM base registers via CAMI.

**Current experiments**:
- [NOS_CAMI_Experiment_Analysis.md](NOS_CAMI_Experiment_Analysis.md) — latest run
